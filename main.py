...
def main():
    ...
    with tab3:
        ...
        st.success("La relación Beneficio/Costo estimada para un horizonte de 5 años es de 1.84, confirmando la alta viabilidad financiera e impacto social en Cotopaxi.")

if __name__ == "__main__":
    main()

# Handler para funciones serverless en Vercel
